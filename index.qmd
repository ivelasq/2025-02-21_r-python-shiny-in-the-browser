...
````{.yaml filename="example.qmd" code-line-numbers=|1-6|8,10|12|13-16|18-31}
---
title: "ggplot2 demo"
format: 
  html:
...
::: notes
Quarto extensions let you customize and extend Quarto’s functionality beyond its built-in features. They enable: New Output Formats – Create custom templates for reports, presentations, or interactive documents, Custom Shortcodes & Filters – Modify how Quarto processes content, such as adding new syntax or automating formatting, and Custom Layouts & Themes – Design unique styling and layouts for HTML, PDF, or Word outputs. Quarto has a Lua-based extension system, and you can make your own, too.
:::
...
[![](images/pyshiny.png){width=80% fig-align="center"}](https://shinylive.io/py/examples/){target=_blank}
...
* Present interactive walkthroughs in lectures
